...
public class SpringJdbcUserDaoImpl03 extends JdbcDaoSupport implements UserDao {
	...
	// /Field
	/*
	 * private JdbcTemplate jdbcTemplate; private NamedParameterJdbcTemplate
	 * namedParameterJdbcTemplate;
	 */

	/*
	 * public void setJdbcTemplate(JdbcTemplate jdbcTemplate){
	 * System.out.println("::"+getClass()+".setJdbcTemplate() Call...");
	 * this.jdbcTemplate = jdbcTemplate; } public void setNamedParamjdbcTemplate
	 * (NamedParameterJdbcTemplate namedParamJdbcTemplate) {
	 * System.out.println("::"+getClass()+".setNamedParamjdbcTemplate() Call");
	...
	public SpringJdbcUserDaoImpl03() {
		System.out.println("::" + getClass()
				+ ".SpringJdbcUserDaoImpl02 디폴트 생성자 Call");
	}
